...
router.post('/', function (req, res, next) {
  ...
  const products = `INSERT INTO products (productId, productName,  productQuantity, productUrl, categoryId, similarProduts) values (?, ?, ?, ?, ?, ?)`;
  ...
  connection.beginTransaction(function (err) {
    ...
    connection.query(productCategoryQuery, [productCategory], function (error, results) {
      ...
      connection.query(products, [productId, productName, productQuantity, productUrl, categoryId, JSON.stringify(similarProduts)], function (error, results) {
